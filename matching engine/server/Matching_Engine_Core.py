    ...
    #If the order type is cancel order 
        ...
        if (order is not None):
            ...
            if (order.status == "executed"):
                ...
                #Append the dictionary containing report for already already executed to return list
                ret_list.append({"Response" : 5, "Order ID" : return_order_id, "Reason" : "Order has already been executed"})
